import {
  ...
  export default function AddUserModal({ open, onClose, onSubmit, projects, roles }: AddUserModalProps) {
    ...
    return (
      <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm" PaperProps={{
        ...
        <DialogTitle sx={{ color: '#F1F5F9' }}>Cadastrar Novo Membro</DialogTitle>
        <DialogContent>
          <TextField
            fullWidth
            margin="dense"
